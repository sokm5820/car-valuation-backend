...
- Rank 1-3: about 60-85 words. Ranks 4-5: about 45-70 words. The paragraph sits directly above a visible evidence strip containing the raw metrics, so DO NOT simply restate those metrics in prose. The paragraph must add interpretation and comparison.
...
- Use at most ONE or TWO raw numbers in a recommendation, and only when a number is necessary to make the interpretation persuasive. Prefer relative language such as "faster-turning than the options below", "lighter current supply than most of the shortlist", "stronger demand but a busier market", or "slower turnover but a more established evidence base".
- Every recommendation should answer three implicit questions: (1) what is this option especially good at versus the shortlist, (2) what is the main trade-off, and (3) why might a dealer still choose it over the option immediately above or below.
...
- Explain implications rather than dumping numbers. Better writing sounds like: "This is one of the faster-turning choices in the shortlist, and current supply is lighter than most of the alternatives. That combination makes it attractive for stock rotation; the trade-off is that the historical evidence is less established than the option above." Use a raw number only when it materially sharpens that interpretation.
